...
export function TelegramLoginButton(props: {
  ...
  return (
    <Button
      ...
      className="h-10 w-10 p-0 flex items-center justify-center rounded-md border border-border bg-secondary/40 text-primary transition-colors hover:bg-secondary/60 disabled:opacity-60"
    >
