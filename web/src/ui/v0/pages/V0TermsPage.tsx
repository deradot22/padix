...
export function V0TermsPage() {
  return (
    <article className="mx-auto max-w-3xl space-y-6 text-foreground">
      ...
      <p>
        These terms and conditions apply to the padix app (hereby referred to as "Application") for mobile devices
        that was created by Nikita Ostroverkhiy (hereby referred to as "Service Provider") as a Free service.
      </p>
      ...
      <p>
        ...
        rights, and other intellectual property rights related to the Application remain the property of the
        Service Provider.
      </p>
      ...
      <Section title="Third-party services">
        ...
        <ul className="list-disc space-y-1 pl-6">
          <li>
            <ExternalLink href="https://policies.google.com/terms">Google Play Services</ExternalLink>
          </li>
          <li>
            <ExternalLink href="https://www.google.com/analytics/terms/">Google Analytics for Firebase</ExternalLink>
          </li>
          <li>
            <ExternalLink href="https://firebase.google.com/terms/crashlytics">Firebase Crashlytics</ExternalLink>
          </li>
        </ul>
      </Section>
      ...
      <p>
        ...
        functions of the Application require an active internet connection, which can be Wi-Fi or provided by your
        mobile network provider. The Service Provider cannot be held responsible if the Application does not
      ...
      <p>
        ...
        application, you accept responsibility for any such charges, including roaming data charges if you use the
        application outside of your home territory (i.e., region or country) without disabling data roaming. If you
        are not the bill payer for the device on which you are using the application, they assume that you have
      ...
      <p>
        In terms of the Service Provider's responsibility for your use of the application, it is important to note
        that while they strive to ensure that it is updated and accurate at all times, they do rely on third
        parties to provide information to them so that they can make it available to you. The Service Provider
        accepts no liability for any loss, direct or indirect, that you experience as a result of relying entirely
      ...
      <p>
        ...
        the application so that it is relevant to you and/or compatible with the particular operating system
        version installed on your device. However, you agree to always accept updates to the application when
        offered to you. The Service Provider may also wish to cease providing the application and may terminate its
        use at any time without providing termination notice to you. Unless they inform you otherwise, upon any
        termination, (a) the rights and licenses granted to you in these terms will end; (b) you must cease using
