...
private data class RoundCost(
    ...
    companion object {
        ...
        /**
         * BALANCED: жёсткий cap первым (matches over cap наказываем), затем РОТАЦИЯ,
         * затем уже мягкая минимизация totalBalance внутри cap.
         *
         * Раньше totalBalance стоял ВТОРЫМ — это создавало залипание: при разнородных
         * рейтингах часто существует единственная партиция с минимальным totalBalance,
         * и алгоритм крутил одни и те же 4 пары много раундов подряд.
         */
