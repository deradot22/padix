...
class PlayerController(
    ...
    @Operation(
        summary = "Лучшие напарники игрока (ТОП по win-rate с поправкой на размер выборки)",
        description = "Партнёры, с которыми игрок чаще всего побеждал, отсортированные по полю score — " +
            "нижней границе 95%-доверительного интервала Уилсона для доли побед (надёжнее сырого winRate). " +
